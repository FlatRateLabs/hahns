...
(function () {
  ...
  /* ================================================================== *
   * SERVICE XPRESS TORQUE (v0.4.1) — oil drain plug + wheel bolt torque
   * from the yearly "VW Service Xpress" charts. Same local-only, keep-the-
   * PDF, auto-reparse posture as fluids, but keyed by SOURCE FILE (one chart
   * bundles several model years). Everything except the two torques is ignored.
   * ================================================================== */
